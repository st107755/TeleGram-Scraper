...
# %% Barchart selected keys
# ToDo sortierung Weerte innerhalb der Liste 
plt.bar(range(len(selected_data)), list(selected_data.values()), align='center')
plt.xticks(range(len(selected_data)), list(selected_data.keys()))
plt.title('Häufigkeit ausgewählte Begriffe')
